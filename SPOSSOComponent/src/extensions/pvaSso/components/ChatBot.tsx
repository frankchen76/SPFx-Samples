...
export const PVAChatbotDialog: React.FunctionComponent<IChatbotProps> = (props) => {
    ...
    //const sendMessage = ReactWebChat.hooks.useSendMessage();
        ...
        <>
            ...
            <Dialog styles={{
                ...
                <div id="chatContainer" style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                    <div ref={webChatRef} role="main" style={{ width: "100%", height: "0rem" }}>
                        <TextField label="Standard" value={prompt} onChange={onPromptChange} />
                        <IconButton iconProps={{ iconName: 'Send' }} title="Send" ariaLabel="Send" onClick={onPromptSend} />
