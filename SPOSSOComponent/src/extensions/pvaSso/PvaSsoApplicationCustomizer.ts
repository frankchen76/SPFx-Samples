...
import { WebChatView } from './components/WebChatView';
...
export default class PvaSsoApplicationCustomizer
    ...
    private _renderPlaceHolders(): void {
        ...
        if (!this._bottomPlaceholder) {
            ...
            const elem: React.ReactElement = React.createElement<IChatbotProps>(WebChatView, { ...this.properties, userEmail: user.email, userFriendlyName: user.displayName });
