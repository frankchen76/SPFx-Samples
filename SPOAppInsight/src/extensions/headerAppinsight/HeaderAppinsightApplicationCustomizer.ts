...
export default class HeaderAppinsightApplicationCustomizer
    ...
    public onInit(): Promise<void> {
        ...
        let appInsightKey: string = this.properties.appInsightsKey;
        if (!appInsightKey || appInsightKey == "") {
            const appkeyobj = require("../../../appinsightkey.json");
            if (appkeyobj != null && appkeyobj["key"]) {
                appInsightKey = appkeyobj["key"];
            }
        }
