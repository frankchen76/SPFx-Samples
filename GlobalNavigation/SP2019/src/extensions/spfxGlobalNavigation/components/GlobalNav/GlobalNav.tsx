...
export default class Header extends React.Component<
  ...
  public componentWillMount(): void {
    this.globalNavProvider = new GlobalNavProvider(this.props.webUrl);
  }
    ...
    this.globalNavProvider
      ...
      .then(
        (result: IGlobalNavItem[]): void => {
          console.log("Data was loaded" + result.length.toString());
          this.setState({
    ...
    return (
      <div className="global-nav">
        <ul className="gn-root">
          {this.state.globalNavItems && this.state.globalNavItems.map(
